...
THREE.GPUParticleSystem = function(options) {
	...
	self.particleNoiseTex = textureLoader.load("app/javascripts/libs/game_lib/textures/perlin-512.png");
	self.particleNoiseTex.wrapS = self.particleNoiseTex.wrapT = THREE.RepeatWrapping;

	self.particleSpriteTex = textureLoader.load("app/javascripts/libs/game_lib/textures/particle2.png");
